...
//    }
////    NSLog(@"%@", [[arrayOfCategoriesNamesWithImages objectAtIndex:2] objectForKey:@"Name"]);
//    //Assigning of filled array to singleton's object property.
////    NSLog(@"SORTER THE COUNT IS %lu", (unsigned long)[ [DataCollector sharedInstance].arrayOfCategoriesAndImages count]);
